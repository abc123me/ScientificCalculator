...
public class FunctionFactory {
	...
	//ax^2 + bx + c
	public static UnaryFunction quadratic(Vector vertex, double a){
		return new UnaryFunction() {
			@Override
			public double f(double x) {
	...
	public static BinaryFunction circle(Vector vertex, double r){
	...
	public static BinaryFunction ellipse(Vector vertex, double w, double h){
		return new BinaryFunction() {
			@Override
			public double Yt(double t) {
	...
	public static PointSlopeLine line(Vector start, Vector end){
		return line(start, end, false);
	}
	public static PointSlopeLine line(Vector start, Vector end, boolean limited){
